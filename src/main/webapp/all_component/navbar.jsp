  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <c:if test="${userobj.role eq 'admin' }">
         ...
         <li class="nav-item">
           <a class="nav-link" href="add_job.jsp"><i class="fa-regular fa-square-plus"></i>Post Jobs</a>
         </li>
      <li class="nav-item">
        <a class="nav-link" href="veiw_jobs.jsp"><i class="fa-solid fa-eye"></i>View Jobs</a>
      </li> 
    ...
    <c:if test="${userobj.role eq 'admin' }">
     ...
     <a href="login.jsp"class="btn btn-light mr-1"><i class="fa-sharp fa-solid fa-right-to-bracket"></i>Login</a>
